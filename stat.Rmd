...
In this final step, we perform model diagnostics to see if assumptions are satisfied for our chosen, optimal model. Specifically, we assess whether our model of choice violates the assumptions of multicollinearity by using VIF values, non-linearity, unequal error variances, and outliers by examining residual vs. fitted plot.
