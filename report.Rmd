...
* What are the factors that influence sanitary grading? As a consumer, does their choice involving the borough of the restaurant, the price range of the restaurant, the cuisine type of their choosing have an effect on the sanitary grading of the restaurant?

* What is the relationship between reviewer's rating of the restaurant and other variables including inspection score, boroughs, price range, review numbers, cuisine type? If an investor wishes to open a new restaurant and maximize review score on Yelp, which factors should he consider and which areas should he focus on investing in?
...
In the first part of our statistical analysis, we performed chi-square tests to investigate the relationship between 
